package troy.stockwatcher.client;
...
public class StockWatcher implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		Timer refreshTimer = new Timer() {
			...
			public void run() {
				...
				//Randomly choose RPC or Json
				long bit = System.currentTimeMillis() & 1;
				
				if(bit == 1){
					System.out.println("Refreshing with RPC");
					refreshWatchList();
				}					
				else {
					System.out.println("Refreshing with Json");
	...
	private void updateTableJson(JsArray<StockData> prices) {

		for (int i = 0; i < prices.length(); i++) {
			updateTableJson(prices.get(i));
		}
	...
	private void updateTableJson(StockData price) {
	...
	// The following methods all use the RPC communications method
